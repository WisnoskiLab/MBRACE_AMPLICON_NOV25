...
write_csv(class_summary, "Results/Distance_decay/subcommunity_ASV_summary.csv")
write_csv(read_summary, "Results/Distance_decay/subcommunity_read_summary.csv")
write_csv(rare_check_summary, "Results/Distance_decay/rare_ASV_QC_summary.csv")
write_csv(dd_pairs, "Results/Distance_decay/pairwise_distance_decay_data.csv")
write_csv(dd_stats, "Results/Distance_decay/distance_decay_statistics.csv")
write_csv(mantel_results, "Results/Distance_decay/mantel_results.csv")
write_csv(rank_stats, "Results/Distance_decay/taxonomic_resolution_distance_decay.csv")
write_csv(niche_width, "Results/Distance_decay/niche_width.csv")

ggsave("Figures/Distance_decay/rank_abundance.png", p_rank, width = 8, height = 6, dpi = 600)
ggsave("Figures/Distance_decay/subcommunity_spatial_abundance.png", p_subcommunity, width = 10, height = 6, dpi = 600)
ggsave("Figures/Distance_decay/bray_subcommunities.png", p_bray, width = 9, height = 6, dpi = 600)
ggsave("Figures/Distance_decay/geographic_distance_decay.png", p_dd, width = 10, height = 8, dpi = 600)
ggsave("Figures/Distance_decay/environmental_distance_decay.png", p_env, width = 10, height = 8, dpi = 600)
ggsave("Figures/Distance_decay/salinity_distance_decay.png", p_salinity, width = 10, height = 8, dpi = 600)
ggsave("Figures/Distance_decay/taxonomic_resolution_distance_decay.png", p_rank_decay, width = 10, height = 6, dpi = 600)
ggsave("Figures/Distance_decay/niche_width.png", p_niche, width = 9, height = 6, dpi = 600)
